...
> ⚠️ **Amendé le 23/07/2026 — AD-034.** La confirmation est **allégée** : fenêtre « Confirmer l'arrêt ? » + **message pré-rempli éditable**, **sans ressaisie du mot de passe** (rapidité en situation de stress). Le garde-fou anti-accident et le message personnalisé sont conservés.
